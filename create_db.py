...
select ads.id as ad_id, ads.title as ad_title, ads.url as ad_url, (select img.src from img where img.ad_id = ads.id) as img_src, ads.published as ad_date from ads''')
